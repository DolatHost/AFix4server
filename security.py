...
os.system("sudo ufw allow"+" "+portssh)
time.sleep(4)

#Close Private IP Range
os.system("sudo ufw deny out to 10.0.0.0/8")
os.system("sudo ufw deny out to 172.16.0.0/12")
os.system("sudo ufw deny out to 192.168.0.0/16")
os.system("sudo ufw deny out to 100.64.0.0/10")
os.system("sudo ufw deny out to 198.18.0.0/15")
os.system("sudo ufw deny out to 169.254.0.0/1")
